...
require (
	...
	github.com/pavolloffay/opentelemetry-mcp-server/modules/schemagen v0.0.0
	github.com/spf13/cobra v1.10.1
)

replace github.com/pavolloffay/opentelemetry-mcp-server/modules/collectorschema => ./modules/collectorschema

replace github.com/pavolloffay/opentelemetry-mcp-server/modules/schemagen => ./modules/schemagen
